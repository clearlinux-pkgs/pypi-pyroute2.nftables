...
Provides: pyroute2.nftables
Provides: pyroute2.nftables-python
Provides: pyroute2.nftables-python3
...
%prep
%setup -q -n pyroute2.nftables-0.6.5
cd %{_builddir}/pyroute2.nftables-0.6.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641479108
...
cp %{_builddir}/pyroute2.nftables-0.6.5/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.5/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
