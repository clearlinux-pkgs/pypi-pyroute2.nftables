...
Source0  : https://files.pythonhosted.org/packages/b9/0e/d5addb79d820beb286b3ef680fd5db4ee630f908d0bfd7ef77f5adb49642/pyroute2.nftables-0.6.8.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-0.6.8
cd %{_builddir}/pyroute2.nftables-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103737
...
cp %{_builddir}/pyroute2.nftables-0.6.8/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.8/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
