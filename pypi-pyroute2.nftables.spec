...
Version  : 0.6.11
Release  : 17
URL      : https://files.pythonhosted.org/packages/01/3a/e4f696d243244224e5022ff259ce702895ae25f029f55831be400a435a9d/pyroute2.nftables-0.6.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/01/3a/e4f696d243244224e5022ff259ce702895ae25f029f55831be400a435a9d/pyroute2.nftables-0.6.11.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-0.6.11
cd %{_builddir}/pyroute2.nftables-0.6.11
pushd ..
cp -a pyroute2.nftables-0.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654538419
...
cp %{_builddir}/pyroute2.nftables-0.6.11/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.11/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
