...
Version  : 0.6.7
Release  : 13
URL      : https://files.pythonhosted.org/packages/23/4b/beb3b3e9572fff1cf764974dd758a79857340d6e53eef080f2d1e13d533e/pyroute2.nftables-0.6.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/23/4b/beb3b3e9572fff1cf764974dd758a79857340d6e53eef080f2d1e13d533e/pyroute2.nftables-0.6.7.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-0.6.7
cd %{_builddir}/pyroute2.nftables-0.6.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645464751
...
cp %{_builddir}/pyroute2.nftables-0.6.7/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.7/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
