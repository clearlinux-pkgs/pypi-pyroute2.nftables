...
Source0  : https://files.pythonhosted.org/packages/72/fa/73c894fa9729606211945a51d83605afb09df83f0a0662fbc749e84ecb17/pyroute2.nftables-0.6.9.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-0.6.9
cd %{_builddir}/pyroute2.nftables-0.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647894024
...
cp %{_builddir}/pyroute2.nftables-0.6.9/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.9/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
