...
Version  : 0.6.10
Release  : 16
URL      : https://files.pythonhosted.org/packages/97/88/77d9dc2ae13c7215d4493f9dc8e7f2ce29ffdb2a94b0b361ba873ed2d526/pyroute2.nftables-0.6.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/97/88/77d9dc2ae13c7215d4493f9dc8e7f2ce29ffdb2a94b0b361ba873ed2d526/pyroute2.nftables-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-0.6.10
cd %{_builddir}/pyroute2.nftables-0.6.10
pushd ..
cp -a pyroute2.nftables-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528547
...
cp %{_builddir}/pyroute2.nftables-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.nftables-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.nftables/4cc77b90af91e615a64ae04893fdffa7939db84c
